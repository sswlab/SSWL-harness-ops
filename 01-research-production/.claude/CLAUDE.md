...
| 명령 | 효과 |
|---|---|
| `/goal <연구 주제·목적·작업경로>` | **최대 노력 모드** — 전체 모드 강제, thinking max, Ambiguity ≤0.10, literature 50편+, 각 Phase에 Self-Critique. **Phase 2~3 (설계·실행)에 깊이 집중**: 대안 설계 ≥3 / 대안 방법 ≥3 / Baseline ≥2 / Ablation / Sensitivity / 통계 검증 / 실패 케이스. **Phase 4~5 (검토·논문)는 기존 구성 유지** (reviewer 루프 최대 2회, paper-writer 리비전 기존, 초안 수준). 정의: `.claude/commands/goal.md` |
